...
class SuggestJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $job = Job::create(['uuid' => $this->uuid, 'name' => 'Suggest - ' . ucFirst($this->params['keyword']), 'user_id' => 1, 'type_id' => 5, 'status_id' => 2, 'percentage' => 5, 'message' => 'Initialisation du traitement']);
