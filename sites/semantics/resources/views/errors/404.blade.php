...
@section('content')
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        <h1 class="text-lg font-medium mr-auto">{{ $exception->getMessage() !== ""  ? $exception->getMessage() :  "Désolé, cette ressource n'existe pas."}}</h1>
    </div>
    <h2 class="font-medium mr-auto">Statut HTTP 404</h2>
