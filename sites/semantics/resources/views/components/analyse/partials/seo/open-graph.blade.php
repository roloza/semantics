<input class="absolute opacity-0" id="tab-single-open-graph" type="radio" name="tabs2">
<label class="block p-5 leading-normal cursor-pointer font-semibold" for="tab-single-open-graph">Détail des balises Open-graph</label>
        ...
        <div class="overflow-x-auto">
            <table class="table">
                ...
                <tbody>
                    ...
                    @if (isset($audit->structure['openGraph']))
                        <?php $cpt = 0 ?>
                        @foreach ($audit->structure['openGraph'] as $name => $value)
