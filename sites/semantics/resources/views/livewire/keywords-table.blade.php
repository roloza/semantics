    ...
    <div class="mt-5 overflow-x-auto">
        <table class="table border ">
            ...
            <tr>
                ...
                <x-table-header :direction="$orderDirection" :field="$orderField" name="freq" style="width:100px">Frequence</x-table-header>
                <x-table-header :direction="$orderDirection" :field="$orderField" name="nb_doc" style="width:100px">Nbdoc</x-table-header>
